...
class TagCreatorController:
    ...
    def __create_tag(self, product_code: str) -> str:
        ...
        path_from_tag = barcode_handler.create_barcode(product_code)  # Corrigido o nome da variável
    ...
    def __format_response(self, path_from_tag: str) -> Dict:
        return {
            "data": {
                "type": "Tag Image",
                "count": 1,  # Corrigido o valor de 'count' para 1, já que só estamos criando uma tag
